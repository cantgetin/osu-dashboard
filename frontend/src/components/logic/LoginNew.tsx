            ...
            <DropdownMenu modal={false} open={isOpen} onOpenChange={setIsOpen}>
                <DropdownMenuTrigger asChild>
                    <Button
                        variant="ghost"
                        className={cn(
                            "relative rounded-full flex items-center gap-2 bg-zinc-900 hover:bg-zinc-800 text-zinc-100",
                ...
                <DropdownMenuContent
                    className="w-56 bg-zinc-900 border-zinc-700 text-zinc-200"
                    align="end"
                    forceMount
                ...
                >
                    <DropdownMenuLabel className="font-normal bg-zinc-900">
                        <div className="flex flex-col space-y-1">
                            <p className="text-sm font-medium leading-none text-zinc-100">{user.name}</p>
