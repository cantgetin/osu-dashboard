                ...
                {props.data.length > 1 ?
                    <>
                        ...
                        <div className="flex gap-2 justify-center items-center ml-auto px-2">
                            <div
                                className="text-xl text-pink-300">{aveta(props.data[props.data.length - 1].favourite_count)} Favorites
                            </div>
                        ...
                        <div className="flex gap-2 justify-center items-center ml-auto px-2">
                            <div
                                className="text-xl text-green-200">{aveta(props.data[props.data.length - 1].play_count)} Plays
                            </div>
