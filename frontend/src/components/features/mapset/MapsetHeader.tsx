    ...
    return (
        <div>
            <div className="flex gap-4 items-center">
                <h1 className="text-5xl drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,1)]">{title}</h1>
                <Button
            ...
            <h1 className="text-4xl text-zinc-400 drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,1)]">by {artist}</h1>
        </div>
    );
};
