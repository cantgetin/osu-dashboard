...
type Config struct {
	...
	TrackingMaxParallelWorkers     int           `env:"TRACKING_MAX_PARALLEL_WORKERS" envDefault:"3"`
	TrackingMaxParallelMapsetCalls int           `env:"TRACKING_MAX_PARALLEL_MAPSET_CALLS" envDefault:"3"`
